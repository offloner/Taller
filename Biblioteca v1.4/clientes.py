...
def Formulario():
    ...
    try:
        ...
        tree = ttk.Treeview(groupbox, columns=("Rut","Nombres","Apellidos","Telefono", "Correo", "Direccion", "Sexo"), show='headings', height=10,)
...
def modificarRegistros():
     ...
     try:
         ...
         direccion = textBoxDireccion.get()
         clave = ''
         CClientes.modificarClientes(idUsuario, nombre, apellido, telefono, correo, direccion, sexo, clave)
